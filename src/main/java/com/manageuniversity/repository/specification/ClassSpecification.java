...
public class ClassSpecification implements Specification<Class> {
	...
	public Predicate toPredicate(Root<Class> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
		...
		Join<Class, Teacher> teacherJoin = root.join("teacher", JoinType.LEFT);
		Join<Class, Course> courseJoin = root.join("course", JoinType.LEFT);
		...
		for (SearchCriteria criteria : list) {
			...
			case GREATER_THAN:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(builder.greaterThan(teacherJoin.get("id"),
			...
			case LESS_THAN:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(
							builder.lessThan(teacherJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("courseId")) {
					predicates.add(
			...
			case GREATER_THAN_EQUAL:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(builder.greaterThanOrEqualTo(teacherJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("courseId")) {
			...
			case LESS_THAN_EQUAL:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(builder.lessThanOrEqualTo(teacherJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("courseId")) {
			...
			case EQUAL:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(
							builder.equal(teacherJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("courseId")) {
					predicates
							.add(builder.equal(courseJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
			...
			case NOT_EQUAL:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(
							builder.notEqual(teacherJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("courseId")) {
					predicates.add(
			...
			case IN:
				if (criteria.getKey().equals("teacherId")) {
					predicates.add(builder.in(teacherJoin.get("id"))
							.value(ConvertString.convertListInteger((String[]) criteria.getValue())));
				} else if (criteria.getKey().equals("teacherName")) {
					predicates.add(builder.in(teacherJoin.get("name"))
