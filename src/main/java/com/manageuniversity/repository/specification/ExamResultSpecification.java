...
public class ExamResultSpecification implements Specification<ExamResult> {
	...
	public ExamResultSpecification() {
	...
	public Predicate toPredicate(Root<ExamResult> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
		...
		Join<ExamResult, Exam> examJoin = root.join("exam", JoinType.LEFT);
		Join<ExamResult, Class> classJoin = root.join("classes", JoinType.LEFT);
		...
		for (SearchCriteria criteria : list) {
			...
			case GREATER_THAN:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(builder.greaterThan(studentJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("examId")) {
					predicates.add(
							builder.greaterThan(examJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("classId")) {
					predicates.add(
							builder.greaterThan(classJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				}
			...
			case LESS_THAN:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(
							builder.lessThan(studentJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("examId")) {
					predicates.add(
							builder.lessThan(examJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("classId")) {
					predicates.add(
			...
			case GREATER_THAN_EQUAL:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(builder.greaterThanOrEqualTo(studentJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("examId")) {
					predicates.add(builder.greaterThanOrEqualTo(examJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("classId")) {
			...
			case LESS_THAN_EQUAL:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(builder.lessThanOrEqualTo(studentJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("examId")) {
					predicates.add(builder.lessThanOrEqualTo(examJoin.get("id"),
							Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("classId")) {
			...
			case EQUAL:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(
							builder.equal(studentJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("examId")) {
					predicates.add(builder.equal(examJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} else if (criteria.getKey().equals("classId")) {
					predicates
							.add(builder.equal(classJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
			...
			case NOT_EQUAL:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(
							builder.notEqual(studentJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				}
				else if (criteria.getKey().equals("examId")) {
					predicates.add(
							builder.notEqual(examJoin.get("id"), Integer.parseInt(criteria.getValue().toString())));
				} 
				else if (criteria.getKey().equals("classId")) {
					predicates.add(
			...
			case IN:
				if (criteria.getKey().equals("studentId")) {
					predicates.add(builder.in(studentJoin.get("id"))
							.value(ConvertString.convertListInteger((String[]) criteria.getValue())));
				} else if (criteria.getKey().equals("studentName")) {
					predicates.add(builder.in(studentJoin.get("name"))
							.value(ConvertString.convertListString((String[]) criteria.getValue())));
				} else if (criteria.getKey().equals("examId")) {
					predicates.add(builder.in(examJoin.get("id"))
							.value(ConvertString.convertListInteger((String[]) criteria.getValue())));
				} 
				else if (criteria.getKey().equals("examName")) {
					predicates.add(builder.in(examJoin.get("name"))
							.value(ConvertString.convertListString((String[]) criteria.getValue())));
				}
				else if (criteria.getKey().equals("classId")) {
