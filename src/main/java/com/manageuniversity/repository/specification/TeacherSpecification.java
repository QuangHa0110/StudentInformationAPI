...
public class TeacherSpecification extends MySpecification<Teacher> implements Specification<Teacher> {
	/**
	 * 
	 */
	...
	public TeacherSpecification(List<List<String>> requestList, Integer size) {
